...
class Constants
{
   ...
   */
  public static final TITLE:String = "Friday Night Funkin' Plus Plus";
  ...
  public static final JUDGEMENT_KILLER_COMBO_BREAK:Bool = false; // will re-add later!
  ...
  public static final JUDGEMENT_MISS_COMBO_BREAK:Bool = true;
   ...
   *
   * NOTE: redirects to Preferences.ghostTapping! Also, this variable is deprecated!
   */
