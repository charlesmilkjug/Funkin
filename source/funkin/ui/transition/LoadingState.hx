...
class LoadingState extends MusicBeatSubState
{
  ...
  override function update(elapsed:Float):Void
  {
    ...
    if (callbacks != null)
    {
      ...
      /*
        This if-check prevents the setGraphicSize function, from setting the width of the loadBar to the height of the loadBar.
          It's a behaviour that is implemented in the setGraphicSize() function.
          Also, if the width parameter is equal to 0.
       */
      if (lerpWidth > 0)
      {
